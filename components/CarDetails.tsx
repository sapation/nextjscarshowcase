                             ...
                             bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                                ...
                                <div className='flex-1 flex flex-col gap-3'>
                                    <div className='relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg'>
                                        <Image src={generateCarImageUrl(car)} alt='car detail'
                                        fill priority className="object-contain"
                                        />
                                    </div>
                                    <div className='flex gap-3'>
                                        <div className="flex-1 relative w-full h-20 bg-primary-blue-100 rounded-lg">
                                            <Image src={generateCarImageUrl(car,'29')} alt='car detail'
                                        fill priority className='object-contain'
                                        />
                                        </div>
                                        <div className="flex-1 relative w-full h-20 bg-primary-blue-100 rounded-lg">
                                            <Image src={generateCarImageUrl(car,'33')} alt='car detail'
                                        fill priority className="object-contain"
                                        />
                                        </div>
                                        <div className="flex-1 relative w-full h-20 bg-primary-blue-100 rounded-lg">
                                            <Image src={generateCarImageUrl(car,'13')} alt='car detail'
                                        fill priority className="object-contain"
                                        />
                                        </div>
                                    </div>
